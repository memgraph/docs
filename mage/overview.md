...
| [community_detection_online](/mage/query-modules/cpp/community-detection-online)   | C++    | Dynamic community detection algorithm suitable for large-scale graphs based upon label propagation. Runs in *O(m)* time and has *O(mn)* space complexity.                                                                         |
