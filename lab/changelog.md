...
- Syntax of code blocks in the query collection description can now be
  ...
  ![markdown](./data/markdown.png)
- [New
  functions](https://memgraph.com/docs/memgraph-lab/style-script/gss-functions)
  of the Graph Style Script language used for customizing graph appearance are:
  `Reduce`, `Sum`, `Avg`, `Min`, `Max`, `IsArray`, `Hue`, `Saturation`,
  `Lightness`, `HSL`. 
