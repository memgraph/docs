        ...
        <div className={styles.homePlaygroundEmbed}>
            ...
            <Container>
                ...
                <div className={styles.homePlaygroundEmbed__subtitle}>
                    <p>In <a href="https://https://playground.memgraph.com/">Memgraph Playground</a> you can explore data sets, run example queries, check out the integrated graph visualizations - and get a jump start on your data driven project.</p>
                </div>
