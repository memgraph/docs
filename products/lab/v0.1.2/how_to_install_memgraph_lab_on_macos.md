...
with a login screen. The username and password fields are only for Memgraph
...
Click on login and you should be presented with the following dashboard:

![](data/image2.png)

Note: You might receive the following error message when trying to login into
Memgraph Lab
