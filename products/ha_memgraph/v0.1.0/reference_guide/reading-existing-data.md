...
This clause is used to obtain data from HA Memgraph by matching it to a given
...
openCypher has functions for aggregating data. HA Memgraph currently supports
