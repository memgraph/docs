...
:::tip
For an example of how to implement transformation modules in C, check out [C API guide](/database-functionalities/streams/kafka/implement-transformation-module.md#c-api).
:::
