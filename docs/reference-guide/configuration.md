...
| --init_file | Path to cypherl file which contains queries that need to be executed before bolt server starts like creating users.<br> Setting this file will delete all files in data directory before executing queries from given cypherl file.| `[string]` |
