...
Nodes are `User`, `Movie` and `Genre`, and the relationships are `RATED` and
`OF_GENRE`.
...
6. List all the files in the `/usr/lib/memgraph/query_modules` folder and check if the `movielens2.py` file is there.
