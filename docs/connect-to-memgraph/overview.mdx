                    ...
                    <div className={styles.connectToMemgraph}>
                        ...
                        */}
                        ...
                        <section>
                            <h2>Where to next?</h2>
                            <p>
                                You can also easily connect to an instance running in <a href="https://cloud.memgraph.com/">Memgraph Cloud</a>. To learn more about the <b>Cypher</b> language, visit the <b><a href={useBaseUrl('cypher-manual')}>Cypher manual</a></b> or <b><a href="https://playground.memgraph.com/">Memgraph Playground</a></b> for interactive guides.
                                For real-world examples of how to use Memgraph, we strongly suggest going
                                through one of the available <b><a href={useBaseUrl('memgraph/tutorials')}>Tutorials</a></b>.
                            </p>
                        </section>
                    </div>
                </Container>
