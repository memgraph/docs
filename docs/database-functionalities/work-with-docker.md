...
* [programmatically](../getting-started/connecting-applications/connecting-applications.md) by using the Bolt protocol,
...
With this, your developing environment is ready and you are able to easily implement and run your own query modules. Check out our [Reference Guide](../reference-guide/query-modules/query-modules.md) to see which Query Modules are included in Memgraph. 
