...
```
As you can see, first parameter is optional, rest of them depend on procedure you are trying to call. Optional parameter
must be result of aggregation function `project`, about which you can read more [here](/cypher-manual/functions#aggregation-functions).
If such parameter is provided, **all** operations will be executed on projected graph. Otherwise, you will work on
graph you have stored inside Memgraph. 
