...
* Added WebSocket server that forwards certain information from Memgraph
  to the clients connected to it (e.g. logs). [#337](https://github.com/memgraph/memgraph/pull/337)
