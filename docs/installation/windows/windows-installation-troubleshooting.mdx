...
To access the files store on your Windows system, you would need to mount the
drive to WSL to freely explore the Windows file system:
...
libraries in WSL, follow [this
guide](https://docs.microsoft.com/en-us/windows/python/web-frameworks#install-python-pip-and-venv).
If you are not interested in working with those modules, you can ignore the
warnings. 
